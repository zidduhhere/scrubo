...
class TProductAttributes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        final varitaion = product.varitaions[controller.variationIndex.value];
        return Column(
          children: [
            TRoundedContainer(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      const Expanded(
                        flex: 5,
                        child: TTitleTextWidget(text: 'Variation'),
                      ),
                            ...
                            Row(
                              children: [
                                ...
                                StrikePriceTextWidget(
                                  ...
                                  price: ProductModel.getPreviousPrice(
                                          varitaion.price.toDouble())
                                      .toString(),
                      ...
                      Expanded(
                        flex: 3,
                        child: IconButton(
                            onPressed: () => controller.onVariationChanged(
                                controller.variationIndex.value + 1,
                                product.varitaions.length),
